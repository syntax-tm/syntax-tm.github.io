...
function buildDevCategory(): XmbCategory {
  ...
  category.addItem("stack-overflow", "StackOverflow",  getIcon('stackOverflow'), 'https://stackoverflow.com/users/6823084/trey', 'View StackOverflow profile');
...
function buildGamingCategory(): XmbCategory {
  ...
  category.addItem("battle-net", "Battle.Net",  getIcon('battleNet'), "/copy?title=Battle.Net&name=BattleTag%3A&value=Gundwn%2311586", 'View Battle.Net profile');
  category.addItem("exophase", "Exophase",  getIcon('exophase'), 'https://www.exophase.com/user/Gundwn/', 'View Exophase profile');
  category.addItem("true-achievements", "TrueAchievements",  getIcon('trueachievements'), 'https://www.trueachievements.com/gamer/Gundwn', 'View TrueAchievements profile');
...
function buildSocialCategory(): XmbCategory {
  ...
  category.addItem("stats-fm", "Stats.fm",  getIcon('statsFm'), 'https://stats.fm/gundwn', 'View stats.fm profile');
...
function buildSettingsCategory(): XmbCategory {
  ...
  category.addItem("github-actions", "Builds",  getIcon('githubActions'), 'https://github.com/syntax-tm/syntax-tm.github.io/actions', 'View latest builds on GitHub');
  ...
  category.addItem("next-js", "Next.js",  getIcon('nextJs'), 'https://nextjs.org/', 'About Next.js');
  category.addItem("font-awesome", "FontAwesome", getIcon('fontAwesome'), 'https://fontawesome.com/', 'About FontAwesome');
